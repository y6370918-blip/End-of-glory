...
function payload() {
	...
	return {
		...
		baseRevision: "revision-1", editorProtocol: 4, modes: ["move", "attack", "supply", "sr", "retreat", "advance"],
		edgeTypes: ["land"], edgeFlags: ["difficult", "alpine", "requires_land_attack_support"]
	}
}
