...
export const EDITOR_EDGE_FLAGS = Object.freeze(["alpine", "requires_land_attack_support"])
...
export function auditSpaceDefinition(space) {
	...
	if (space?.vp != null && typeof space.vp !== "boolean") errors.push(`${id} vp必须为布尔值`)
	for (const property of Object.keys(space || {}))
		if (!["id", "name", "nation", "faction", "terrain", "supply", "port", "ui", "fort", "large_area", "vp", "control"].includes(property))
